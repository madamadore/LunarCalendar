...
public class MoonTest {
    ...
    public void testLunarPhase() throws ParseException {
        ...
        assertEquals(LunarCalendar.MOON_PHASE.WAXING_TO_QUARTER, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("30/01/2020")));
        assertEquals(LunarCalendar.MOON_PHASE.WAXING_TO_QUARTER, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("30/11/2019")));
        assertEquals(LunarCalendar.MOON_PHASE.WAXING_TO_QUARTER, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("30/09/2019")));
        assertEquals(LunarCalendar.MOON_PHASE.LAST_QUARTER, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("08/03/2018")));
        ...
        assertEquals(LunarCalendar.MOON_PHASE.NEW, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("13/06/2018")));
        ...
        assertEquals(LunarCalendar.MOON_PHASE.FIRST_QUARTER, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("20/06/2018")));
        assertEquals(LunarCalendar.MOON_PHASE.WAXING_TO_FULL, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("25/06/2018")));
        assertEquals(LunarCalendar.MOON_PHASE.FULL, moon.getLunarPhase(new SimpleDateFormat("dd/MM/yyyy").parse("29/05/2018")));
